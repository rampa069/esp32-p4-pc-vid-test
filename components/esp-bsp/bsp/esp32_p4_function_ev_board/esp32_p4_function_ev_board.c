...
esp_err_t bsp_display_new_with_handles(const bsp_display_config_t *config, bsp_lcd_handles_t *ret_handles)
{
    ...
    /* Backlight uses GPIO23 which is claimed by MIPI DSI PHY on HDMI builds — skip */
...
#error The color format must be RGB888 in HDMI display type!
    ...
    case BSP_HDMI_RES_640x480:
        ESP_LOGI(TAG, "HDMI configuration for 640x480@60HZ (CEA-861 VIC1)");
        /* CEA-861 VIC1: 640x480@60Hz
         * pclk=25.175MHz, htotal=800, vtotal=525
         * hfp=16, hpw=96, hbp=48, vfp=10, vpw=2, vbp=33
         * polaridades: ambas negativas */
        {
            static const esp_lcd_panel_lt8912b_video_timing_t timing_480p = {
                .hfp        = 16,
                .hs         = 96,
                .hbp        = 48,
                .hact       = 640,
            ...
            static const esp_lcd_dpi_panel_config_t dpi_480p = {
            ...
            vendor_config.mipi_config.dpi_config = &dpi_480p;
            memcpy(&vendor_config.video_timing, &timing_480p,
    ...
    case BSP_HDMI_RES_1280x720:
        ESP_LOGI(TAG, "HDMI configuration for 1280x720@60HZ (CEA-861 timings)");
        /* CEA-861 VIC4: 1280x720@60Hz
         * pclk=74.25MHz, htotal=1650, vtotal=750
         * hfp=110, hpw=40, hbp=220, vfp=5, vpw=5, vbp=20
         * These are the EXACT timings the monitor expects via HDMI */
        {
            static const esp_lcd_panel_lt8912b_video_timing_t timing_720p = {
                .hfp        = 110,
                .hs         = 40,
                .hbp        = 220,
                .hact       = 1280,
                ...
                .pclk_mhz   = 74,  /* 74.25 rounded — DPI clock set separately */
            };
            static const esp_lcd_dpi_panel_config_t dpi_720p = {
                .dpi_clk_src        = MIPI_DSI_DPI_CLK_SRC_DEFAULT,
                .dpi_clock_freq_mhz = 74,   /* closest integer to 74.25 MHz */
                .virtual_channel    = 0,
                .in_color_format    = LCD_COLOR_PIXEL_FORMAT_RGB888,
                .num_fbs            = CONFIG_BSP_LCD_DPI_BUFFER_NUMS,
                .video_timing = {
            ...
            vendor_config.mipi_config.dpi_config = &dpi_720p;
            memcpy(&vendor_config.video_timing, &timing_720p,
                   sizeof(esp_lcd_panel_lt8912b_video_timing_t));
        }
        break;
